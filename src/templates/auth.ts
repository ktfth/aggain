...
export function generateAuthModel(options: AuthOptions): string {
...
export function generateAuthController(options: AuthOptions, framework: 'koa' | 'express'): string {
  const { authType } = options;
...
export function generateAuthMiddleware(options: AuthOptions, framework: 'koa' | 'express'): string {
  const { authType } = options;
...
export function generateAuthRoutes(options: AuthOptions, framework: 'koa' | 'express'): string {
  const { authType } = options;
