...
describe('Express Generator', () => {
  ...
  it('should create project with all files', async () => {
    await generateExpressProject(mockOptions);
  ...
  it('should handle errors gracefully', async () => {
    ...
    await expect(generateExpressProject(mockOptions)).rejects.toThrow('Test error');
  });

  it('should not create test files when tests are disabled', async () => {
    const optionsWithoutTests = { ...mockOptions, includeTests: false };
    await generateExpressProject(optionsWithoutTests);
