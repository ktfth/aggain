...
function generateRouteTemplate(name: string, framework: string): string {
...
function generateControllerTemplate(name: string, framework: string): string {
  if (framework === 'express') {
...
function generateMiddlewareTemplate(name: string, framework: string): string {
  if (framework === 'express') {
    return `import { Request, Response, NextFunction } from 'express';
...
function generateTestTemplate(name: string, type: string, framework: string): string {
