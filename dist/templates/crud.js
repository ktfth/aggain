...
export function generateKoaController(options) {
...
export function generateExpressController(options) {
    const { entityName } = options;
    const EntityName = capitalize(entityName);
...
export function generateKoaRoutes(options) {
    const { entityName } = options;
    const EntityName = capitalize(entityName);
...
export function generateExpressRoutes(options) {
    const { entityName } = options;
    const EntityName = capitalize(entityName);
