...
export async function generateSubmodule(options, projectPath) {
...
function generateModel(SubmoduleName, properties) {
...
function generateService(ModuleName, SubmoduleName) {
...
function generateKoaController(ModuleName, SubmoduleName) {
...
function generateExpressController(ModuleName, SubmoduleName) {
...
function generateExpressRoutes(ModuleName, SubmoduleName) {
...
function generateKoaRoutes(ModuleName, SubmoduleName) {
...
function generateValidation(SubmoduleName, properties) {
